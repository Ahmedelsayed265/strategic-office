  ...
  return (
    <>
      ...
      <div className="flex items-center mt-4 justify-between">
        ...
        <div className="flex items-center gap-2">
          <button 
            className="bg-[#DFF6E7] p-2 hover:bg-[#c8e6d3] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            onClick={async (e) => {
              e.preventDefault();
              e.stopPropagation();
              ...
              try {
                await exportToPDF("printable-content");
          ...
          >
            {isExportingPDF ? (
              <div className="w-5 h-5 border-2 border-[#25935F] border-t-transparent rounded-full animate-spin"></div>
            ) : (
